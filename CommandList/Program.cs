...
namespace CommandArray
{
    ...
    class Program
    {
            ...
            while (!exiting)
            {
                ...
                switch (menuChoice)
                {
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        DisplayEcecuteFinchCommands(myFinch, commands, motorSpeed, LEDBrightness, delayDuration);
                        break;
                    case "e":
                    case "E":
                        exiting = true;
        ...
        static void DisplayEcecuteFinchCommands(Finch myFinch, List<FinchCommand> commands, int motorSpeed, int lEDBrightness, int delayDuration)
        {
        ...
        static void DisplayFinchCommands(List<FinchCommand> commands)
        {
            ...
            {
                Console.WriteLine("Please enter Finch Robot commands frist.");
            }
